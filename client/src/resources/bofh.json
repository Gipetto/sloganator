[
  ...
  "Unfortunately we have run out of bits/bytes/whatever. Don't worry, a fresh supply will be coming next week.",
  ...
  "error: bad user found in front of screen",
  ...
  "Hackers used Mongo DB default password to truncate database."
]